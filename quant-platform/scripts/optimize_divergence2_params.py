    ...
    params.update(
        {
            ...
            "day1_min_volume_ratio": round(rng.uniform(0.8, 1.6), 2),
            "day1_max_volume_ratio": round(rng.uniform(2.5, 5.0), 2),
            "range_min_amplitude_30": round(rng.uniform(0.10, 0.30), 3),
            "range_min_return_20": round(rng.uniform(-0.05, 0.12), 3),
            "day2_min_pct_chg": round(rng.uniform(-5.0, -2.0), 1),
            "day2_max_pct_chg": round(rng.uniform(6.0, 8.5), 1),
            "day2_max_volume_ratio": round(rng.uniform(1.5, 2.1), 2),
            ...
            "entry_min_open_gap_pct_chg": round(rng.uniform(0.8, 2.0), 1),
            "entry_max_open_gap_pct_chg": round(rng.uniform(5.0, 7.0), 1),
            "entry_min_high_from_open_pct_chg": round(rng.uniform(2.8, 4.5), 1),
        }
    )
    return params
